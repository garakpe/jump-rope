...
class StorageKeys {
  ...
  static const String pendingTaskUpdates = 'pendingTaskUpdates';
}
...
class AppStrings {
  ...
  static const String offlineMode = '오프라인 모드: 변경 사항은 네트워크 연결 시 동기화됩니다.';
  static const String syncInProgress = '데이터 동기화 중...';
