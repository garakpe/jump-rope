...
class TaskModel {
  ...
  final String? videoId; // 유튜브 비디오 ID 추가
  ...
  static List<TaskModel> getIndividualTasks() => const [
        TaskModel(
            ...
            videoId:
                "https://www.youtube.com/shorts/YMpqfoe5Ae4?feature=share"),
        TaskModel(
            id: 2,
            name: "구보로 뛰기",
            count: "50회",
            ...
            videoId:
                "https://youtube.com/shorts/rW91LN-0aL4?si=iyWknu8WtmP51ArV"),
        TaskModel(
            id: 3,
            name: "십자뛰기",
            count: "20회",
            ...
            videoId:
                "https://youtube.com/shorts/bs6A7xuZhkc?si=FZcZN2l75E7QHxeR"),
        TaskModel(
            id: 4,
            name: "가위바위보 뛰기",
            count: "30회",
            ...
            videoId:
                "https://youtube.com/shorts/9UQCai3S6vE?si=_cYo5c9CW_9gecY8"),
        TaskModel(
            id: 5,
            name: "엇걸었다 풀어 뛰기",
            count: "10회",
            ...
            videoId:
                "https://youtube.com/shorts/nFMLZ8brwYs?si=ZlURXB_n4KHTTUQC"),
        TaskModel(
            id: 6,
            name: "이중뛰기",
            count: "10회",
            ...
            videoId:
                "https://youtube.com/shorts/zVCY6nQP5WY?si=YuMjOZSNxQ-wuyoy"),
      ];
  ...
  static List<TaskModel> getGroupTasks() => const [
        TaskModel(
            ...
            videoId:
                "https://youtube.com/shorts/C7UBPaR-4ck?si=0NwIdz4as9T3X3Gf"),
        TaskModel(
            id: 2,
            name: "엇갈아 2인뛰기",
            count: "20회",
            ...
            videoId: "https://youtu.be/TFUVOxDMj1k?si=VfRWFWraOCU83Ul3"),
        TaskModel(
            id: 3,
            name: "배웅통과하기",
            count: "4회",
            ...
            videoId: "https://youtu.be/3NUxC-wVZu8?si=vFF2gsCLGtYVBpgM"),
        TaskModel(
            id: 4,
            name: "1인 4도약 연속뛰기",
            count: "2회",
            ...
            videoId: "https://youtu.be/tZPeALG3bpk?si=P0GudygpKMQyRNmi"),
        TaskModel(
            id: 5,
            name: "단체줄넘기",
            count: "30회",
            ...
            videoId: "https://youtu.be/8ALWBISuoXA?si=Ht-vR9RNrI-udJVW"),
        TaskModel(
            id: 6,
            name: "긴 줄 연속 8자 뛰기",
            count: "40회",
            ...
            videoId: "https://youtu.be/PWfsPBlyRJY?si=CXpNnuRStawvTBEl"),
      ];
}
